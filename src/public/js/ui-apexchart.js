...
var options = {
  series: [
    ...
    {
      name: "Desk Auditor",
      data: [67, 99, 76, 80, 50, 80, 69, 87, 77],
    },
    {
      name: "Onsite Auditor",
      data: [44, 76, 67, 56, 43, 43, 34, 50, 40],
    },
  ],
  chart: {
    height: 400,
...
var radialMandatory = new ApexCharts(
  document.querySelector("#mandatoryCriteria"),
  radialMandatoryCriteria
);
var radialOptional = new ApexCharts(
  document.querySelector("#optionalCriteria"),
  radialOptionCriteria
);
var radialSpesific = new ApexCharts(
  document.querySelector("#spesificCriteria"),
  radialSpesificCriteria
);
var area = new ApexCharts(document.querySelector("#area"), areaOptions);

area.render();
radialMandatory.render();
radialOptional.render();
radialSpesific.render();
candle.render();
bar.render();
line.render();
